...
- `--image` is **required** until a public a2wave registry ships (build locally from the repo with `docker compose build`, image tag `a2wave:latest`). Never invent a registry URL.
