...
export interface QQOfficialChannelSectionProps {
  ...
  onEnableGroupAndC2cChange?: (value: boolean) => void
  enableGuildMessages?: boolean
  onEnableGuildMessagesChange?: (value: boolean) => void
  enableGuildDirectMessages?: boolean
  onEnableGuildDirectMessagesChange?: (value: boolean) => void
  ...
  guildReplyMode?: ReplyMode
  onGuildReplyModeChange?: (value: ReplyMode) => void
  guildDmReplyMode?: ReplyMode
  onGuildDmReplyModeChange?: (value: ReplyMode) => void
  ...
  return (
    <div className="space-y-5">
      ...
      <div className="space-y-3">
        <SettingSwitch
          label={t('agentPublish.qqOfficialEnableGroupAndC2c')}
          checked={props.enableGroupAndC2c ?? true}
          onChange={props.onEnableGroupAndC2cChange}
        />
        <SettingSwitch
          label={t('agentPublish.qqOfficialEnableGuild')}
          checked={props.enableGuildMessages ?? true}
          onChange={props.onEnableGuildMessagesChange}
        />
        <SettingSwitch
          label={t('agentPublish.qqOfficialEnableGuildDm')}
          checked={props.enableGuildDirectMessages ?? true}
          onChange={props.onEnableGuildDirectMessagesChange}
        />
        <SettingSwitch
        ...
        />
        <SettingSwitch
          label={t('agentPublish.qqOfficialGroupAllMessages')}
          checked={props.groupTriggerOnNewMessage ?? false}
          onChange={props.onGroupTriggerOnNewMessageChange}
        />
        <SettingSwitch
      ...
      <div className="grid gap-4 sm:grid-cols-2">
        {(
          [
            ...
            ['qqOfficialGuildReplyMode', props.guildReplyMode, props.onGuildReplyModeChange],
            ['qqOfficialGuildDmReplyMode', props.guildDmReplyMode, props.onGuildDmReplyModeChange],
          ] as const
